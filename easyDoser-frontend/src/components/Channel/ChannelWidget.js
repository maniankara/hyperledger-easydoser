...
export default function ChannelWidget(props){
    ...
    <div onClick = {()=>{
        ...
        <CardHeader color="warning" stats icon>
            ...
            <p>{props.item.toString().substring(0,1).toUpperCase()+props.item.toString().substring(props.item.length-1, props.item.length).toUpperCase()}</p>
            </CardIcon><br/>
           ...
           <CardBody>
                ...
                <IconButton background="primary" onClick={()=>{
                           ...
                           { !expanded?( <ExpandMoreIcon fontSize="large"/>):(
